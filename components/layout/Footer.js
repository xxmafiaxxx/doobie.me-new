									...
									<div className="position-relative newsletter-inner">
										<div className="newsletter-content">
											...
											<p className="mb-45">
												...
												<span className="text-brand">Doobie</span>
											</p>
							...
							<div className="row">
								...
								<div className="col-lg-1-5 col-md-4 col-12 col-sm-6">
									...
									>
										...
										<div className="banner-text">
											<h3 className="icon-box-title">Drone delivery</h3>
						...
						<div className="container pt-15 pb-20">
							<div className="row">
									...
									>
										...
										<ul className="contact-infor">
											...
											<li>
												...
												/>
												<strong>Hours:</strong>
												<span>9:00am - 12:am, Mon - Sun</span>
											</li>
										</ul>
									</div>
								</div>
								...
								<div
									...
									data-wow-delay=".3s"
								>
									<h4 className="widget-title ">Investors</h4>
									<ul className="footer-list  mb-sm-5 mb-md-0">
										<li>
						...
						<div className="row align-items-center">
							...
							<div className="col-xl-4 col-lg-6 col-md-6">
								<p className="font-sm mb-0">
									&copy; 2022, <strong className="text-brand">Doobie</strong> -
									Drone Delivery <br />
									All rights reserved
								</p>
							</div>
							<div className="col-xl-4 col-lg-6 text-center d-none d-xl-block">
								<div className="hotline d-lg-inline-flex mr-30">
									...
									/>
									<p>
										1 929 487 3802<span>Working 8:00 - 22:00</span>
									</p>
								</div>
								<div className="hotline d-lg-inline-flex">
									...
									/>
									<p>
										1 929 487 3802<span>24/7 Support Center</span>
									</p>
								</div>
							</div>
