...
export default function ProductCard(props) {
  const { procuctCard, overrides, ...rest } = props;
  return (
    <Flex
      gap="0"
      direction="row"
    ...
    >
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children={procuctCard?.shortDescription}
